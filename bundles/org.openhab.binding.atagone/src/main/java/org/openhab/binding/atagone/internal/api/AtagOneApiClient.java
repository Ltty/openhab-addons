...
public class AtagOneApiClient {
     ...
     * {@code resets} bump, and no other error signal. See {@code dev-notes/DEVELOPERS.md} for the
     * live-test writeup. {@code base_temp} has no such ambiguity — it's always a genuine fractional
     * value — so it's left to Gson via {@code addProperty(String, Number)}.
     */
